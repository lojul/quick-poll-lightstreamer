        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3">
            ...
            <div className="flex items-center justify-center gap-4 py-3 bg-muted/50 rounded-lg">
              ...
              <div className="text-center">
                <div className="text-sm text-muted-foreground">需要貓爪幣</div>
            ...
            <p className="text-sm">
              您還需要 <span className="font-semibold text-red-600">{shortage}</span> 貓爪幣才能{actionText}。
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
